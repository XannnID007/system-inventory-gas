...
@section('content')
    <div class="space-y-6" x-data="{ activeTab: '{{ auth()->user()->isOwner() ? 'toko' : 'profil' }}' }">
            ...
            <div class="flex gap-2">
                @if (auth()->user()->isOwner())
                    <button @click="activeTab = 'toko'"
                        :class="activeTab === 'toko' ? 'gradient-purple text-white shadow-lg' :
        ...
        @if (auth()->user()->isOwner())
            ...
            <div x-show="activeTab === 'toko'" x-transition class="glass-white rounded-2xl p-8 shadow-xl">
                ...
                <form action="{{ route('owner.pengaturan.toko.update') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                        ...
                        <div class="flex items-center gap-6">
                            ...
                            @else
                                <div
                                    class="w-24 h-24 gradient-purple rounded-xl flex items-center justify-center shadow-lg">
